...
#mpiexec -n 128 python scripts/liras/forward_simulations.py B 2200 3000 ${SNIC_NOBACKUP}/src/liras/data/forward_simulations_b_hamp hamp_space mwi mwi_full ici
...
mpiexec -n 128 python scripts/liras/forward_simulations.py A 2800 3600 ${SNIC_NOBACKUP}/src/liras/data/forward_simulations_a_reference.nc --simple lcpr mwi mwi_full ici
mpiexec -n 128 python scripts/liras/forward_simulations.py B 2200 3000 ${SNIC_NOBACKUP}/src/liras/data/forward_simulations_b_reference.nc --simple lcpr mwi mwi_full ici
