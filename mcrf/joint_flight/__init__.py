...
cloud_water_a_priori = FixedAPriori("cloud_water", -6, liquid_covariance, mask=liquid_mask, mask_value=-20)
cloud_water_a_priori = MaskedRegularGrid(cloud_water_a_priori, 11, liquid_mask, "altitude", provide_retrieval_grid=False)
...
rain_n0_a_priori = MaskedRegularGrid(rain_n0_a_priori, 10, rain_mask, "altitude", provide_retrieval_grid=False)
