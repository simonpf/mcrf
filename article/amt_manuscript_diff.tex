...
%DIF ADD amt_manuscript_revised.tex   Wed Mar 11 09:08:14 2020
%% ---------------------------------
...
radar-only }\DIFaddend retrieval, also a \DIFdelbegin \DIFdel{radar-only and a passive only-retrieval are performed. The radar-only retrievaluses the same implementation as }\DIFdelend \DIFaddbegin \DIFadd{one-moment version (M1), in only the $D_m$
...
scattering properties it covers.
...
\DIFaddbegin \begin{table}
  ...
  \begin{tabular}{l|l|rr|rr}
    ...
    %DIF >  GEM Snow
    %DIF > 
    \hline \DIFaddFL{GEM Snow }& \DIFaddFL{Evans Snow Aggregate (1) }& \DIFaddFL{$10\ $ }& \DIFaddFL{$127\ $ }& \hfill \DIFaddFL{0.2 }&
    \hfill \DIFaddFL{2.39 }\\ & \DIFaddFL{GEM Snow (32) }& \DIFaddFL{$107\ $ }& \DIFaddFL{$5000\ $ }& \hfill \DIFaddFL{24 }& \hfill \DIFaddFL{2.86
    }\\
    %DIF > 
    %DIF >  Gem Graupel
    %DIF > 
...
channel provide complementary information \DIFdelbegin \DIFdel{on the parameters }\DIFdelend \DIFaddbegin \DIFadd{two degrees of freedom }\DIFaddend of the PSD. \DIFdelbegin \DIFdel{Considering the panels corresponding to the MWI channels, the }\DIFdelend \DIFaddbegin \DIFadd{The
...
species. This means that the reference IWC is the sum }\DIFdelend \DIFaddbegin \DIFadd{masses }\DIFaddend of the four frozen
...
is observed for all tested particle shapes and thus likely independent of it. In general, the radar-only results exhibit only very weak dependency on the
...
\ref{fig:results_a}), the \DIFdelbegin \DIFdel{analysis of the results of }\DIFdelend \DIFaddbegin \DIFadd{best overall performance for IWC and IWP is from }\DIFaddend the
combined retrieval \DIFdelbegin \DIFdel{presented in Figs.~\ref{fig:results_scatter_a_1} , \ref{fig:results_scatter_a_2}
}\DIFdelend \DIFaddbegin \DIFadd{as shown in Fig.~\ref{fig:results_scatter_a} }\DIFaddend and in
...
\DIFdelbegin \DIFdel{Unfortunately, no evidence of a relation between the $\chi^2_y$ value and
...
the retrieval results}\DIFaddend .
