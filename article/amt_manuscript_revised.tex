...
\begin{abstract}
  ...
  Remote-sensing observations in the sub-millimeter domain provide better
  ...
  global distribution of ice in the atmosphere. The launch of the Ice Cloud
  Imager (ICI) radiometer on board the second generation of European operational
  meteorological satellites (Metop-SG) marks a milestone in this development
  with which sub-millimeter observations of ice clouds will become available
  operationally. Observations at these novel frequencies are valuable not only
  on their own but also in combination with observations at other frequencies
  and sensors. This study investigates the potential benefits of combining
  passive sub-millimeter radiometer observations combined with a hypothetical
  W-band cloud radar for the retrieval of frozen hydrometeors. Using a
  ...
  retrieval algorithm for airborne observations is proposed and applied to
  simulated observations from a cloud-resolving atmosphere model. Results from
  ...
  configurations. The impact of the assumed ice particle shape on the retrieval
  results are assessed for all retrieval implementations. Although they show
  greater sensitivity to the assumed particle shape, the synergistic
  observations can better constrain the microphysics of the cloud, which
  decreases uncertainties in retrieved IWC and improves the retrieval of
  particle number densities. Our results also indicate improved sensitivity
  to liquid cloud water content for the synergistic configuration compared to a
  passive-only setup. The results of this study demonstrate potential of the
  synergistic sensor configuration to improve retrievals of frozen hydrometeors.
