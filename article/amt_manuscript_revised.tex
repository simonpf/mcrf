...
of one frozen and one liquid hydrometeor species in the atmospheric column along
with profiles of atmospheric humidity and liquid-cloud water content (LCWC). The
resolutions of the vertical grids of the GEM model and of the retrieved
quantities for different retrieval configurations are displayed in
