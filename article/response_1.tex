...
and IWP when this is not the case (}\DIFaddend Fig.~9\DIFdelbegin \DIFdel{. In general, the passive-only and the combined retrievals display }\DIFdelend \DIFaddbegin \DIFadd{). The DARDAR product
...
\begin{change}[513]
\DIFaddbegin \DIFadd{It should be noted, that none of the presented retrievals accounts for the error
