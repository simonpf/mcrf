...
\item The following text has been added to the description of the retrieval
...
different concentrations, sizes and shapes (c.f. Fig.~2). Since
...
hydrometeors are retrieved at reduced resolution.For ice, }\DIFdelend \DIFaddbegin \DIFadd{will not be
...
particles are listed in Tab.~4. Three of them, GEM
...
because they now convey slightly different information.
...
\item The following paragraph has been added to the conclusions:
  \begin{change}[555]
...
To clarify how our work goes beyond what GPM does, a paragraph detailing this
...
provide additional information on cloud microphysics (Fig.~5)
