...
\begin{abstract}
  ...
  clouds. To investigate what can be learned about ice clouds from these newly
  ...
  information content in the radar and radiometer observations helps to better
  constrain the particle size distribution of the ice cloud. The feasibility of
  the combined retrieval is demonstrated by applying a one-dimensional,
  variational cloud-retrieval algorithm to simulated observations from a
  high-resolution atmospheric model. Comparison of the results with passive- and
  radar-only versions of the retrieval algorithm confirms that the synergistic
