...
%DIF DEL amt_manuscript_revised.tex     Thu May 14 10:47:53 2020
%DIF ADD amt_manuscript_revised_2.tex   Mon May 18 12:31:42 2020
%% ---------------------------------
...
precipitation. \DIFdelbegin \DIFdel{Hence they }\DIFdelend \DIFaddbegin \DIFadd{They }\DIFaddend are employed increasingly in field campaigns to study cloud
microphysics and will be integrated into the global meteorological observing
system to measure the global distribution of ice in the atmosphere. A milestone
in this development is the launch of the Ice Cloud Imager (ICI) radiometer on
board the second generation of European operational meteorological satellites
(Metop-SG), which will make sub-millimeter observations of ice clouds available
operationally. Observations at these novel wavelengths provide valuable
information not only on their own but also in combination with complementary
observations at other wavelengths. This study investigates the potential \DIFdelbegin \DIFdel{benefits }\DIFdelend of
combining passive sub-millimeter radiometer observations with a hypothetical
W-band cloud radar for the retrieval of frozen hydrometeors. \DIFdelbegin \DIFdel{Using a simplified }\DIFdelend \DIFaddbegin \DIFadd{An idealized
}\DIFaddend cloud-model \DIFdelbegin \DIFdel{, }\DIFdelend \DIFaddbegin \DIFadd{is used to investigate }\DIFaddend the information content of the combined
observations \DIFdelbegin \DIFdel{is investigated and }\DIFdelend \DIFaddbegin \DIFadd{and establish }\DIFaddend the capacity of the observations to constrain the
microphysical properties of ice hydrometeors\DIFdelbegin \DIFdel{is established}\DIFdelend . A synergistic retrieval algorithm
...
benefits of the synergistic sensor configurations. The impact of the assumed ice
particle shape on the retrieval results is assessed for all retrieval
implementations. \DIFdelbegin \DIFdel{Although they show greater sensitivity to the assumed
particle shape, the synergistic observations can }\DIFdelend \DIFaddbegin \DIFadd{We find the combined observations to }\DIFaddend better constrain the
\DIFdelbegin \DIFdel{microphysics of the cloud, which decreases uncertainties in retrieved ice
}\DIFdelend \DIFaddbegin \DIFadd{microphysical properties of ice hydrometeors which reduces retrieval
uncertainties in the retrieved }\DIFaddend water content and \DIFdelbegin \DIFdel{improves the retrieval of }\DIFdelend particle number concentrations.
\DIFdelbegin \DIFdel{Our results also indicate improved sensitivity to }\DIFdelend \DIFaddbegin \DIFadd{In addition to this, the combined retrieval provides more accurate retrievals of
}\DIFaddend liquid cloud water content \DIFdelbegin \DIFdel{for the synergistic configuration compared to }\DIFdelend \DIFaddbegin \DIFadd{than }\DIFaddend a passive-only \DIFdelbegin \DIFdel{setup. The
...
synergistic retrievalalgorithm can be applied with only minor modifications
...
}\DIFdelend \DIFaddbegin \DIFadd{retrieval.
}
...
this\DIFdelbegin \DIFdel{importance}\DIFdelend , today's global observing system cannot provide accurate information on the
global distribution of ice in the atmosphere \citep{eliasson11,duncan18a}. A
major difficulty of measuring atmospheric ice using remote sensing lies in the
large variability of \DIFaddbegin \DIFadd{ice particle }\DIFaddend sizes, concentrations and shapes\DIFdelbegin \DIFdel{in which ice particles occur in the atmosphere. The wide spectrum of ice crystal
sizes, which ranges from micro- to millimeter scales, }\DIFdelend \DIFaddbegin \DIFadd{, which }\DIFaddend can
only be partially resolved by available space-borne sensors.

Current operational observation systems used to study clouds can be divided into
two groups by virtue of their observing frequency and \DIFdelbegin \DIFdel{their }\DIFdelend corresponding capabilities
and limitations. Microwave sensors employ \DIFaddbegin \DIFadd{comparably long }\DIFaddend wavelengths ranging
down to about $1\ \unit{mm}$. \DIFdelbegin \DIFdel{Compared to the
}\DIFdelend \DIFaddbegin \DIFadd{Since these wavelengths are large compared to the
typical }\DIFaddend sizes of ice particles \DIFdelbegin \DIFdel{, the wavelengths
are very long and therefore sensitive only to
very large ice particles . At the
same time, they provide the advantage of penetrating even thick clouds}\DIFdelend \DIFaddbegin \DIFadd{in a cloud, these sensors are most sensitive to
its largest particles and don't provide any sensitivity to the small particles
in the cloud}\DIFaddend . Optical and infrared sensors use radiation with wavelengths from
around $15\ \unit{\mu m}$ down to several hundred nano meters. \DIFdelbegin \DIFdel{Although these }\DIFdelend \DIFaddbegin \DIFadd{These }\DIFaddend relatively
short wavelengths make them sensitive \DIFdelbegin \DIFdel{to }\DIFdelend \DIFaddbegin \DIFadd{also to the }\DIFaddend small ice particles \DIFdelbegin \DIFdel{, their signal saturates
for thick clouds, which makes them insensitive to the ice mass further down the line of sight. Although radars and
lidars allow detection of lower ice water
contents }\DIFdelend \DIFaddbegin \DIFadd{in the
...
\DIFadd{Active sensors have the advantage of providing high vertical resolution and
generally higher sensitivity }\DIFaddend than their passive counterparts\DIFdelbegin \DIFdel{, they are ultimately limited by the same principles}\DIFdelend \DIFaddbegin \DIFadd{. This, however,
typically comes at the expense of lower spectral and spatial coverage of
the observations}\DIFaddend .
...
Since the principal target of these missions are retrievals of \DIFdelbegin \DIFdel{liquid
}\DIFdelend \DIFaddbegin \DIFadd{precipitating
}\DIFaddend hydrometeors, they make use of sensors at comparably low microwave frequencies
and hence provide \DIFdelbegin \DIFdel{only limited sensitivity to frozen }\DIFdelend \DIFaddbegin \DIFadd{almost no sensitivity to non-precipitating }\DIFaddend hydrometeors.
...
\DIFdelbegin \DIFdel{With ICI sub-millimeter radiometry of clouds will reach operational status.
This has of course sparked interest in its potential }\DIFdelend \DIFaddbegin \DIFadd{A number of studies have investigated the potential of ICI }\DIFaddend for studying ice in
...
can be gained from combined observations compared to observations from \DIFdelbegin \DIFdel{the }\DIFdelend \DIFaddbegin \DIFadd{a }\DIFaddend radar
...
The GEM model uses a two-moment scheme with six \DIFdelbegin \DIFdel{types }\DIFdelend \DIFaddbegin \DIFadd{classes }\DIFaddend of hydrometeors to
...
characteristic \DIFdelbegin \DIFdel{of the model }\DIFdelend can be identified here, which will help to better understand the
...
with standard deviation \DIFdelbegin \DIFdel{$0.5\ \unit{dBZ}$}\DIFdelend \DIFaddbegin \DIFadd{$0.5\ \unit{dB}$}\DIFaddend .
...
\DIFdelbegin \DIFdel{designed to }\DIFdelend \DIFaddbegin \DIFadd{which }\DIFaddend cover the full range of particle sizes relevant for microwave observations
of ice hydrometeors.
...
retrieval from getting stuck in spurious local minima. \DIFdelbegin \DIFdel{This resembles the
approach }\DIFdelend \DIFaddbegin \DIFadd{A similar approach is
}\DIFaddend taken in the GPM combined precipitation retrievals \citep{grecu16}, where the
PSD parameter \DIFdelbegin \DIFdel{scaling }\DIFdelend \DIFaddbegin \DIFadd{that scales }\DIFaddend the particle concentration is also retrieved at
reduced resolution.
...
\begin{table}[h!]
\caption{A priori uncertainties \DIFaddbeginFL \DIFaddFL{$sigma_q$ }\DIFaddendFL and correlation lengths \DIFaddbeginFL \DIFaddFL{$l_q$ }\DIFaddendFL used in the retrieval.}
 \centering
\label{tab:a_priori}
...
parameter is retrieved has been tested. \DIFdelbegin \DIFdel{For completeness, retrieval results for
IWC will be
reported also for the M1 version. However, to allow for better
comparison with the combined and passive-only retrieval , for the remaining
results only the two-moment version is considered}\DIFdelend \DIFaddbegin \DIFadd{However, results of this version will be
shown only for the comparison of IWC retrieval errors}\DIFaddend . For the passive-only
...
sufficient information to distinguish different \DIFdelbegin \DIFdel{hydrometeor species }\DIFdelend \DIFaddbegin \DIFadd{species of hydrometeors}\DIFaddend . Due to
this ambiguity, frozen hydrometeors in the proposed retrieval algorithm are
represented using only a single hydrometeor species. \DIFdelbegin \DIFdel{It is therefore necessary
to find }\DIFdelend \DIFaddbegin \DIFadd{This requires finding }\DIFaddend a
...
The \DIFdelbegin \DIFdel{differences between hydrometeor species in the test scenes are due to their
different
}\DIFdelend \DIFaddbegin \DIFadd{four species of frozen hydrometeors in the GEM model have different
characteristic particle }\DIFaddend concentrations, sizes and shapes (c.f.
Fig.~\ref{fig:gem_psds}). Since \DIFdelbegin \DIFdel{two parameters of }\DIFdelend \DIFaddbegin \DIFadd{the retrieval can adapt two degrees of freedom
of }\DIFaddend the PSD of frozen \DIFdelbegin \DIFdel{hydrometeor species are retrieved, the
retrieval is able to represent the characteristic }\DIFdelend \DIFaddbegin \DIFadd{hydrometeors, it can represent the variations in particle
}\DIFaddend number concentrations and particle sizes of \DIFaddbegin \DIFadd{the }\DIFaddend different hydrometeor species.
\DIFdelbegin \DIFdel{Variations in particle shape
which }\DIFdelend \DIFaddbegin \DIFadd{By using a habit mix for the ice hydrometeor shape used in the retrieval,
variations in particle shape that }\DIFaddend correlate with particle size\DIFdelbegin \DIFdel{can be represented using a habit mix
combining crystal shapes at small sizes with }\DIFdelend \DIFaddbegin \DIFadd{, such as
differences between pristine crystals and }\DIFaddend aggregates or rimed particles\DIFdelbegin \DIFdel{at
larger sizes. This provides the retrieval with some flexibility to represent the
different shapes present in the test scenes}\DIFdelend \DIFaddbegin \DIFadd{, can
be represented in the retrieval}\DIFaddend .

Even with this configuration\DIFdelbegin \DIFdel{the simplified retrieval forward model will not }\DIFdelend \DIFaddbegin \DIFadd{, the single hydrometeor species used in the
retrieval is unlikely to }\DIFaddend be able to represent \DIFdelbegin \DIFdel{every possible configuration of mixes of the four ice
hydrometeor species }\DIFdelend \DIFaddbegin \DIFadd{the variability present }\DIFaddend in the GEM
model \DIFdelbegin \DIFdel{. It thus remains unclear }\DIFdelend \DIFaddbegin \DIFadd{or the real world. This poses the question }\DIFaddend which particle shape should be
\DIFdelbegin \DIFdel{used to best represent this mixture. We therefore }\DIFdelend \DIFaddbegin \DIFadd{assumed in the retrieval to minimize the resulting representation error. To
answer it, we }\DIFaddend choose a set \DIFdelbegin \DIFdel{consisting }\DIFdelend of multiple particle shapes and habit mixes for which
we investigate the impact of the particle choice on the retrieval results.
\DIFaddbegin 

\DIFaddend The selected particles are listed in Tab.~\ref{tab:particle_properties}. Three
...
\DIFaddend Fig.~\ref{fig:particle_properties} provides an overview of the bulk mass
...
content \DIFaddbegin \DIFadd{(\text{WC})}\DIFaddend :
\begin{align}
  Q &= \frac{\sigma}{\text{WC}}
\end{align}
...
whereas GEM Graupel, \DIFdelbegin \DIFdel{Gem }\DIFdelend \DIFaddbegin \DIFadd{GEM }\DIFaddend Hail and GEM Cloud Ice are more efficient. This
...
\caption{Simulated observations of a homogeneous, $5\ \unit{km}$ thick \DIFaddbeginFL \DIFaddFL{ice }\DIFaddendFL cloud
...
quantities, \DIFdelbegin \DIFdel{both scenes and all tested }\DIFdelend \DIFaddbegin \DIFadd{test scenes and }\DIFaddend particle shapes are provided as digital supplement
to this article.
...
\DIFdelbegin \DIFdel{$10^{-6}\ \unit{kg\ m^{-3}}$}\DIFdelend \DIFaddbegin \DIFadd{$5 \cdot 10^{-6}\ \unit{kg\ m^{-3}}$}\DIFaddend .
...
GEM Graupel particle, for which \DIFdelbegin \DIFdel{quite }\DIFdelend significant misfits are observed in the first
...
\DIFdelbegin \DIFdel{This is in agreement with \mbox{%DIFAUXCMD
...
\DIFdelbegin \DIFdel{cloud is thick}\DIFdelend \DIFaddbegin \DIFadd{clouds are thickest}\DIFaddend . Differences between different particles are observed, but
...
residual is likely \DIFdelbegin \DIFdel{due to the }\DIFdelend \DIFaddbegin \DIFadd{caused by by }\DIFaddend relative efficiencies at different frequencies.
...
error model to these errors, which \DIFdelbegin \DIFdel{are likely }\DIFdelend \DIFaddbegin \DIFadd{can be expected to be }\DIFaddend non-Gaussian and
...
retrieval. \DIFaddbegin \DIFadd{This effect is more clearly visible when the fraction of total
...
\DIFaddbegin \begin{figure}
  ...
  \caption{\DIFaddFL{Ratios of the DFS of the combined retrieval ($\text{DFS}_\text{co}$) and
...
\DIFaddend For the water vapor retrieval, no significant improvements in the combined
...
able \DIFaddbegin \DIFadd{to }\DIFaddend reproduce their vertical structure in regions where the cloud
...
\codeavailability{All code used to produce the results in this study is available from a
  public repository \citep{mcrf}.} %% use this section when having only software code available
